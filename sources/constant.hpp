...
namespace constant
{
	...
	inline constexpr const int square_size = 66;
	...
	inline constexpr const int padding_size = square_size - piece_size;
	inline constexpr const int max_coord_on_board = row_count * square_size + border_size;
